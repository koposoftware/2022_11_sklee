...
## 1. 프로젝트 소개
### 1) 프로젝트 개요
총 3가지 문제에 대한 답을 찾기 위해 본 프로젝트를 기획했습니다. 
<br><br>
첫째로, 회계에 대한 전문 지식이 없는 사람도 회계장부를 쉽게 작성할 수 있는 방안은 없을까에 대한 답을 찾아보았습니다. 현재 기업에서는 회계 지식이 있는 직원 또는 세무사를 고용해 경리 및 세무 업무를 전담시키고 있습니다. 이 업무를 전산화하여 기업에게 관련 부담을 줄일 수 있는 방안으로, 기업에서 발생한 여러 거래들을 회계상황에 따라 분류하고 그에 맞는 회계정보를 저장하고 활용하는 서비스를 구현했습니다.
<br><br>
다음으로 기업의 현재 재무상태를 한 눈에 확인할 수 방법을 찾고 싶었습니다. 회계항목에 대한 배경지식 없이 재무제표의 의미를 파악하기 힘들 수 있습니다. 이 문제를 해결하기 위해 기업의 안정성, 수익성을 나타내는 지표와 기업의 성장성을 나타내는 기업가치 계산결과를 시각화했습니다.
<br><br>
끝으로, 기업이 대출을 필요로 하는 시기를 사전에 진단하고 알려줘 기업의 자금 조달에 어려움이 없게 할 방법을 고민해보았습니다. 이 질문에 대한 답으로, 기업의 현금흐름을 기반으로 유동성 상태를 진단해 상황에 맞는 기업대출을 연계하는 서비스를 구현하게 되었습니다.
<br><br>
