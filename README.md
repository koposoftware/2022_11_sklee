...
- 매출발생 시 상품명, 판매일자(인도일자), 판매금액과 수량, 매출액 지급방식, 비고 등 입력 시 PROCEDURE를 이용해 거래상황에 맞는 차변과 대변의 회계코드를 찾아 회계분개 후 총계정원장 TABLE에 저장<br>
<sub>* 회계분개: 거래에 알맞은 회계 계정과목을 선택하여 금액과 함께 기록하는 절차</sub><br>
<sub>* 차변과 대변: 복식 회계에서의 양 변을 말하는 것으로 좌측이 차변 우측이 대변</sub><br><br>
...
<img src="/img_HanaBizUp/fn3.png"/><br>
